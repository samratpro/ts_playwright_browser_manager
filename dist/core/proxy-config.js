 ...
 */
export function countryFromDataimpulseUsername(username) {
...
export const DEFAULT_FINGERPRINT = FINGERPRINTS['US'];
/**
 * Get appropriate fingerprint for a proxy configuration
 */
export async function getFingerprintForProxy(proxy) {
    let country = null;
